...
![System architecture overview: fragmented data sources flow through the Data Mesh foundation into Block Data MCP and Query Expert MCP, converging at the AI Agent](assets/block/article-0/image-01.png)
...
![Architecture diagram showing Block Data MCP and Query Expert MCP as two separate tools sharing a common data infrastructure](assets/block/article-0/image-02.png)
...
![Block Metrics Store architecture: semantic models feed into the Metrics Store, which serves consumers through CLI tools and a Python API](assets/block/article-0/image-03.png)
...
![Query Expert MCP architecture: table access history feeds an offline data pipeline that produces query text and table metadata embeddings, which power Query Expert](assets/block/article-0/image-04.png)
...
![Block data mesh domains](assets/block/article-0/image-05.png)
...
![MCP Tool Adoption: Unique Users by Quarter](assets/block/article-0/image-06.png)
...
Article diagrams are archived inline above.
